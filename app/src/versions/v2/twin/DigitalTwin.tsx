...
/**
 * Daisy's digital twin — a persistent, always-on assistant available on every
 * scene. Scripted Q&A grounded in named sources; some answers carry actions
 * that jump to the relevant scene or acknowledge work done on her behalf.
 */
