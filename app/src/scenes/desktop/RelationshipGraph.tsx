...
import { client, relationship, type GraphNode } from '../../data/scenario';
...
/**
 * RelationshipGraph — relationship intelligence. A network map of who we know
 * and how well, a health score with trend, plus single-thread risk and the
 * white-space that turns coverage gaps into action.
 */
export function RelationshipGraph() {
  ...
  return (
    <DesktopChrome
      ...
      subtitle="Who we know, how well — and where the gaps are"
    >
