...
import { client, meeting, summary } from '../../data/scenario';

/**
 * PostMeetingSummary — the CRM "one-view" that writes itself minutes after the
 * meeting. Key moments, opportunities, follow-up actions and a ready-to-send
 * email draft, all generated from the live conversation.
 */
    ...
    >
      ...
      <div className="anim-fadeUp mb-4 flex items-center gap-3 rounded-2xl border border-accent/25 bg-accent/10 px-4 py-3">
        ...
        <div className="min-w-0">
          <p className="text-sm font-bold text-accent">Summary written automatically</p>
      ...
      <div className="grid grid-cols-5 gap-4">
        ...
        <div className="col-span-3 space-y-4">
          ...
          <Card className="anim-fadeUp p-5" style={{ animationDelay: '120ms' }}>
            <SectionLabel>Opportunities identified</SectionLabel>
          ...
          <Card className="anim-fadeUp p-5" style={{ animationDelay: '180ms' }}>
            <SectionLabel>Follow-up actions</SectionLabel>
