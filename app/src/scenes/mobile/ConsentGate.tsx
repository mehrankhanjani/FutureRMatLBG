...
import { client, meeting } from '../../data/scenario';
      ...
      <div className="flex min-h-full flex-col bg-ink px-6 py-8">
        <div className="flex flex-1 flex-col items-center justify-center text-center">
          ...
          <p className="mt-2 max-w-[16rem] text-sm text-muted">
            ...
            <span className="font-bold text-text">notes mode</span> — James
            captures key points manually.
          </p>
    ...
    <div className="flex min-h-full flex-col">
      ...
      <div className="relative overflow-hidden bg-brand px-6 pb-8 pt-6 text-ink">
        ...
        <div className="relative">
          ...
          <div className="mb-4 text-sm font-extrabold">Good afternoon, James</div>
